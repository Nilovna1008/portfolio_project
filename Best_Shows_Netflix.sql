...
-- This query bring out the highest score and title of the show in each of the 
-- 12 distinct category of genre, here you see 13 records as a result of Mindhunter & Making a Murderer
-- received a score of 8.6 each in the same category 'crime' --
...
-- This query fetches the highest score of a show in the category of main production, 
-- like Attack on titan, Hunter x Hunter and Death Note have 9 as the highest score and their
-- main production is Japan --
...
-- This query combines the two columns RELEASE_YEAR & MAIN_PRODUCTION into a single column 
-- named as INFO separated by a , --
...
-- This query counts the number of show in each main production whose average 
-- duration is greater than equal to 30 min --
